...
# ─── SOZLAMALAR ────────────────────────────────────────────────────────────────
BOT_TOKEN = "BU_YERGA_BOT_TOKENINGIZNI_KIRITING"   # @BotFather dan olingan token
ADMIN_CHAT_ID = 123456789   # Admin Telegram ID (qabul xabarlarini qabul qilish uchun)
